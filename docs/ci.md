...
| Cypress run         | ~2–3 min | 263 tests, full API + UI + advanced patterns     |
| Node unit suite     | < 1 s    | 152 tests (utils/cron, flakiness, diff, executor, webhooks, webhookSecret, digest, registrationGate) |
